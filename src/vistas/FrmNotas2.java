 ...
 * @author USER
 */
public class FrmNotas2 extends javax.swing.JInternalFrame {
...
////        notasTabla.getTableHeader().getColumnModel().getColumn(8).setMinWidth(0);
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("REGISTRO DE NOTAS POR ALUMNO Y PERIODO");
        ...
        jLabel2.setText("* Cargar todos los alumnos en el semestre y periodo");
        ...
        periodoCmb.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                periodoCmbInputMethodTextChanged(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(41, 41, 41)
                                .addComponent(periodoCmb, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE)))
...
//        periodo = metodosGeneralesDao.codigoPeriodoActivo();
    ...
    private void periodoCmbItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_periodoCmbItemStateChanged
        try {
            Periodo pe = (Periodo) periodoCmb.getSelectedItem();
            periodo.setIdPeriodo(pe.getIdPeriodo());
            periodo.setCodigoPeriodo(pe.getCodigoPeriodo());
        } catch (Exception e) {
            System.out.println(e);
        }
    }//GEN-LAST:event_periodoCmbItemStateChanged

    private void periodoCmbInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_periodoCmbInputMethodTextChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_periodoCmbInputMethodTextChanged
    ...
    private void cargarPeriodo() {
        try {
            ...
            while (resultSet.next()) {
                ...
                p.setIdPeriodo(resultSet.getInt("id1_periodo"));
